      ...
      <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <h3 className="mb-4 text-2xl font-extrabold tracking-wide">IUTians Portal</h3>
            <p className="text-sm text-white/80">
              Your comprehensive campus companion for all IUT students.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-white/20 pt-6 text-center">
          <p className="text-sm text-white/80">
            &copy; {currentYear} IUTians Portal. All rights reserved. | Made with ❤️ for IUT Students
          </p>
        </div>
      </div>
    </footer>
